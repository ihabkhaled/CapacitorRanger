...
import { AppButton, AppCard, AppInput, AppPasswordInput } from '@/shared/ui';
...
export function LoginForm(props: LoginFormProps): React.JSX.Element {
  return (
    <form onSubmit={props.onSubmit} noValidate className="app-auth-form">
      <AppCard>
        <div className="flex flex-col gap-5 p-1 sm:p-3">
          <AppInput
