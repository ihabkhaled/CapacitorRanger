...
export const TEST_IDS = {
  ...
  welcomeFeaturesCta: 'welcome-features-cta',
  siteNavigation: 'site-navigation',
  mobileNavigationToggle: 'mobile-navigation-toggle',
  siteDrawerScrim: 'site-drawer-scrim',
  siteShellContent: 'site-shell-content',
